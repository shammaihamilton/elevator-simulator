...
export const useEffectiveBuildingSettings = (buildingIndex: number) => {
  ...
  return {
    floorsPerBuilding: buildingSettings.floorsPerBuilding ?? globalSettings.buildings.floorsPerBuilding,
    elevatorsPerBuilding: buildingSettings.elevatorsPerBuilding ?? globalSettings.buildings.elevatorsPerBuilding,
    initialElevatorFloor: buildingSettings.initialElevatorFloor ?? globalSettings.buildings.initialElevatorFloor,
    doorOpenTimeMs: buildingSettings.doorOpenTimeMs ?? globalSettings.timing.doorOpenTimeMs,
    doorTransitionTimeMs: buildingSettings.doorTransitionTimeMs ?? globalSettings.timing.doorTransitionTimeMs,
    floorTravelTimeMs: buildingSettings.floorTravelTimeMs ?? globalSettings.timing.floorTravelTimeMs,
    delayPerFloorMs: buildingSettings.delayPerFloorMs ?? globalSettings.timing.delayPerFloorMs,
    // Indicates if this building uses custom settings
